  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        outline:
          "border-border bg-surface hover:bg-muted hover:text-foreground aria-expanded:bg-surface aria-expanded:text-foreground dark:border-input dark:bg-input/30 dark:hover:bg-input/50",
